...
~/iec/local/share/tippecanoe/tippecanoe --force -z9 -Z5 -o $TMP/covid_data.mbtiles --read-parallel --coalesce-smallest-as-needed --detect-shared-borders --generate-ids $IEC/covid/forecasting/district.geojson
