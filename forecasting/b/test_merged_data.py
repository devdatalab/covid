...
pred_data = pd.read_stata(CDATA / 'pred_data_district.dta')
...
merged_data = pd.read_stata(CDATA / 'merged_data_district.dta')
...
# THIS HAS BEEN OVERRULED - we allow for differential dates now
