...
/***************************************************************************/
/* Vaccinations/ Health Services over time(For districts reporting in June) */
/***************************************************************************/
...
twoway (line hm_vac_bcg month) ///
    ...
    (line hm_vac_sessions month), ///
    title("Vaccinations at Birth") ///
    subtitle("For Districts That Reported in June") ///
    ytitle(" ")  ///
    xtitle("") ///
    xlabel(, valuelabels) ///
    ylabel(0(0.2)1) ///
...
/****************************************************************************/
/* Graph Scaled Hospital Services over time for districts reporting in June */
/****************************************************************************/
...
/******************************************************************************/
/* Scaled Vaccinations/Services per hospital (For districts reporting in June) */
/******************************************************************************/
