...
**************************************************************************************
	...
	************************************************************************************
		...
		*Collapse to district level 
		collapse (first) state_name lgd_state_id (mean) i15_*any h365_*any [aw=weight], by(state_code district urban female)
	...
	***************************************************
		...
		*Collapse to district level 
		collapse (first) state_name lgd_state_id (mean) age i15_* [aw=weight], by(state_code district urban female)
		...
		*Apply labels 
		...
		merge 1:1 state_code district urban female using $tmp/nss75/districtdata, nogen
		save $tmp/nss75/districtdata, replace
	...
	**********************************************************
		...
		*Collapse to district level 
		collapse (first) state_name lgd_state_id (mean) age h365_* [aw=weight], by(state_code district urban female)
		...
		*Apply labels 
		...
		order state_name state_code lgd_state_id district urban female age i15_*any i15_* h365_*any h365_*
		
    /* save final dataset */
    save $tmp/nss75/nss75_dist, replace
