/* 08/18/21: Legacy version- 
the historical data (pre-April 27) is no longer available online, so
we have saved that to a permanent file instead of pulling and processing
it every time. This code is a record of how we had been doing that.
